...
model = AuTiSM_Model(N=N, M=M, latent_dim_A=256, latent_dim_B=128).to(device)
...
# Save model weights
torch.save(model.state_dict(), "AuTiSM.pth")
print("Model training complete. Weights saved to 'AuTiSM.pth'.")
